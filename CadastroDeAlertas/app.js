...
form.addEventListener("submit", async function(event){
    ...
    if(idEditando === null){
        ...
        // CREATE
        await fetch("https://alerta-ja-api.onrender.com/alertas", {
            method: "POST",
            headers: {
        ...
        // UPDATE
        await fetch(`https://alerta-ja-api.onrender.com/alertas/${idEditando}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function carregarAlertas(){
    ...
    const response = await fetch("https://alerta-ja-api.onrender.com/alertas");
...
async function excluirAlerta(id){
    ...
    await fetch(`https://alerta-ja-api.onrender.com/alertas/${id}`, {
